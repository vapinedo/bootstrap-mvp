import { useUsers, useDeleteUser, useCreateUser } from '../security/user.hooks';
...
export function UsersList() {
  ...
  const editUser = useCreateUser(); // reutiliza createUser para editar (PATCH/PUT sería ideal, pero backend solo tiene POST)
  ...
  return (
    <Card>
      ...
      <Card.Body>
        ...
        {/* Modal o detalle de usuario (solo muestra datos por ahora) */}
        {selectedUser && (
